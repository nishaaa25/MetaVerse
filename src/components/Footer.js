...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="flex-between flex-wrap gap-4 w-full pb-4">
      ...
      <div className="flex-between flex-wrap gap-4 w-full  border border-x-0 border-b-0 border-t-white border-opacity-10  pt-8">
